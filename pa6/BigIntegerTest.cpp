...
* BigIntegerTest.cpp
* test client for big integer ADT
***/ 
#include<iostream>
#include<string>
#include<stdexcept>
...
int main() {
   cout << "Now testing BigInteger:  " << endl;
   cout << endl;
   ...
   BigInteger Test1 = One-Two;
   cout << "X-Y = " << Test1 << endl;

   BigInteger Test2 = One+Two;
   cout << "X+Y = " << Test2 << endl;

   BigInteger Test3 = One*Two;
   cout << "X*Y = " << Test3 << endl;
   cout << endl;
   ...
   BigInteger Test11 = A1-B1;
   cout << "X-Y = " << Test11 << endl;

   BigInteger Test21 = A1+B1;
   cout << "X+Y = " << Test21 << endl;

   BigInteger Test31 = A1*Two;
   cout << "X*Y(from before) = should be -5000: " << Test31 << endl;
   cout << endl;

   cout << "Now testing input/ouput 1:  " << endl;
   BigInteger O1 = BigInteger("-0041085449");
   BigInteger O2 = BigInteger("7402779357");
   cout << "a = " << O1 << endl;
   cout << "b = " << O2 << endl;
   cout << "a+b = " << O1+O2 << endl;
   ...
   cout << endl;
   cout << "-----------------------------------------------------------------------------  " << endl;
   cout << "Now testing given BigIntegerClient tests:  " << endl;
