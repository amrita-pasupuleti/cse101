...
int main() {
   ...
   cout << "Now testing dictionary . . . " << endl;
   Dictionary Dict;
   Dict.setValue("a", 1);
   Dict.setValue("b", 2);
   Dict.setValue("c", 3);
   ...
   cout << "Dict.size() = " << Dict.size() << endl  << Dict << endl;

   Dict.remove("c");
   cout << "Dict.size() = " << Dict.size() << endl  << Dict << endl;
   cout << endl;

   cout << "Now testing dictionary using given DictionaryClient . . . " << endl;
   string s;
   int x;
   string S[] =   {
                     "plaices",
